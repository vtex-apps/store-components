...
type GradientCollapseProps = OwnGradientCollapseProps &
  typeof GradientCollapse.defaultProps

function GradientCollapse(props: GradientCollapseProps) {
  const {
    children,
    collapseHeight,
    onCollapsedChange,
