...
| ---------- | ----------- | ---------------- |
| `fadeBottom` | The bottom of the collapse | [index](/index.js) |
| `pointerEventsNone` | The GradientCollapse container | [index](/index.js) |
| `pointerEventsAuto` | The _Show Less_/_Show More_ button area | [index](/index.js) |