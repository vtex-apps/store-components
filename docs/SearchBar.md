...
| `containerMode` | `String` | Allows the autocomplete component to be displayed with or without overlap. The available properties are `overlay` and container | `overlay`
